...
export default function PoultryPreStarterct() {
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-w-4xl px-4 md:px-6  w-full">
              <h1 className="text-[#fff] text-4xl md:text-6xl font-bold text-center mb-4 md:mb-6">
                Poultry Pre-Starter{" "}
                <span className="text-[#ffa800]"> Feed </span>
              </h1>
                  ...
                  <div className="mt-6 bg-white rounded-3xl shadow-lg overflow-hidden border border-gray-200 px-6 py-6">
                    <div className=" text-center max-w-3xl mx-auto mb-8">
                      ...
                      <p className="mt-2 md:mt-4 text-gray-600  text-center text-[16px] md:text-[18px]">
                        Poultry Pre-Starter Feed is designed to improve
                        digestion, immunity, and overall development of young
                        calves. Made with natural ingredients, it provides
                        essential nutrients to ensure robust health and optimal
                        growth during the crucial early stages of life
                      </p>
                    </div>
                    {/* ===== NUTRITION GRID ===== */}
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-12">
                      ...
                      <div className="flex items-center justify-center gap-4 p-6 bg-gray-50 rounded-xl shadow-md">
                        ...
                        <div className="text-center">
                          ...
                          <p className="font-semibold text-gray-800">MAX 4%</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-center gap-4 p-6 bg-gray-50 rounded-xl shadow-md">
                        ...
                        />
                        <div className="text-center">
                          <p className="text-gray-500 text-sm">Calcium</p>
                          <p className="font-semibold text-gray-800">
                            MIN 0.9%
                          </p>
                        </div>
                      ...
                      <div className="flex items-center justify-center gap-4 p-6 bg-gray-50 rounded-xl shadow-md">
                        ...
                        />
                        <div className="text-center">
                          <p className="text-gray-500 text-sm">Lysin</p>
                          <p className="font-semibold text-gray-800">
                            1.3 - 1.4%
                          </p>
                        </div>
                      ...
                      <div className="flex items-center justify-center gap-4 p-6 bg-gray-50 rounded-xl shadow-md">
                        ...
                        />
                        <div className="text-center">
                          <p className="text-gray-500 text-sm">Methionine</p>
                          <p className="font-semibold text-gray-800">
                            0.5 - 0.55%
                          </p>
                        </div>
