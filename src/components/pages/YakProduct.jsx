...
export default function YakProduct() {
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-w-4xl px-4 md:px-6  w-full">
              <h1 className="text-[#fff] text-4xl md:text-6xl font-bold text-center mb-4 md:mb-6">
                Yak <span className="text-[#ffa800]"> Feed </span>
              </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 ">
              ...
              <h2 className="text-3xl md:text-5xl font-semibold text-gray-800 text-center mb-4 md:mb-10">
                Yak Feed <span className="text-[#ffa800]">Products</span>
              </h2>
              ...
              <div>
                ...
                <div className="py-4 md:py-8">
                  <div className="mt-4 md:mt-6 bg-white rounded-3xl shadow-lg overflow-hidden border border-gray-200 px-6 py-6">
                    <div className=" text-center max-w-3xl mx-auto mt-4 md:mb-8">
                      ...
                      <p className="mt-2 md:mt-4 text-gray-600  text-center text-[16px] md:text-[18px]">
                        Yak Feed is designed to improve digestion, immunity, and
                        overall development of young calves. Made with natural
                        ingredients, it provides essential nutrients to ensure
                        robust health and optimal growth during the crucial
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-12">
                      {/* Moisture */}
                      <div className="flex flex-col md:flex-row items-center justify-center gap-4 p-2 md:p-6 bg-gray-50 rounded-xl shadow-md">
                        <FontAwesomeIcon
                          icon={faDroplet}
                      ...
                      {/* Fat */}
                      <div className="flex flex-col md:flex-row  items-center justify-center gap-4 p-2 md:p-6bg-gray-50 rounded-xl shadow-md">
                        <FontAwesomeIcon
                          icon={faCube}
