      ...
      <main className="pt-16 overflow-hidden">
        <section className="relative z-0">
         ...
         <section className="py-8 md:py-20 bg-gray-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            ...
            <div className="mt-6 md:mt-10 grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
        ...
        <section>
          <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-20">
            ...
            <div className="mt-4 md:mt-10 grid grid-cols-1 md:grid-cols-2  gap-6 md:gap-8">
        ...
        <section className="relative w-full overflow-hidden  gsap-fade-in">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16 ">
            ...
            <p className="mt-4 md:mt-6 text-white leading-normal md:leading-relaxed text-[16px] md:text-[18px] text-center">
