...
function AboutUs() {
  ...
  const visionMissionData = aboutSettings?.vision_mission || {};
  const visionData = visionMissionData?.vision || {};
  const missionData = visionMissionData?.mission || {};
  const sectionImage = visionMissionData?.section_image_url || "";

  const leadershipData = aboutSettings?.leadership || {};
  const boardDirectors = leadershipData?.board_directors || [];

  const animalFeedStoryData = aboutSettings?.animal_feed_story || {};
  ...
  return (
    <>
      ...
      <main className="pt-16 overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 place-items-center">
              ...
              <motion.div variants={slideInRight}>
                <h2 className="text-3xl md:text-5xl font-semibold text-gray-800 text-center md:text-left">
                  {visionMissionData?.heading || "Vision"}{" "}
                  <span className="text-[#ffa800]">
                    {visionMissionData?.heading_highlight || "& Mission"}
                  </span>
                </h2>
        ...
        <AnimalFeedStory data={animalFeedStoryData} />
        ...
        >
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <motion.h2
              ...
              variants={slideInUp}
            >
              {leadershipData?.heading || "Leadership &"}{" "}
              <span className="text-[#ffa800]">
                {leadershipData?.heading_highlight || "Governance"}
              </span>
            </motion.h2>
            ...
            >
              {boardDirectors.map((member, index) => (
                ...
                >
                  ...
                  >
                    <motion.img
                      src={member?.image_url || officeMan}
                      alt={member?.name}
                      className="w-full"
            ...
            >
              ...
              >
                ...
                <Link
                  to="/our-teams"
                  state={{
                    leadership: aboutSettings?.leadership,
                    team: aboutSettings?.leadership?.team,
                  }}
                  className="bg-yellow-500 hover:bg-yellow-400 px-6 py-3 inline-block rounded-xl text-[16px] font-medium cursor-pointer w-full md:w-auto"
                >
                  Meet Our Complete Team
              ...
              {[
                {
                  ...
                  desc: "We ensure consistent quality in every bag through strict quality control, premium ingredients, and advanced manufacturing practices you can rely on.",
                  check: "50+ Quality Checks",
                },
                {
                  icon: faNutritionix,
                  title: "Science-Driven Nutrition",
                  desc: "Our feeds are carefully formulated using scientific research to deliver balanced nutrition that supports healthy growth, strong immunity, and higher productivity.",
                  check: "Research-Backed",
                },
                {
                  icon: faHandHoldingHeart,
                  title: "Farmers at the Heart",
                  desc: "We exist to serve farmers. Our solutions are designed to be reliable, affordable, and effective—helping farmers achieve better results and long-term success.",
                  check: "Farmer-Centric",
                },
                {
                  icon: faHexagonNodes,
                  title: "Sustainability in Action",
                  desc: "From responsible sourcing to eco-friendly production, we are committed to practices that protect nature and strengthen rural communities.",
                  check: "Eco-Friendly",
                },
                {
                  icon: faTrademark,
                  title: "Consistency You Can Trust",
                  desc: "Every product reflects our dedication to transparency, safety, and performance—building trust with every customer, every time.",
                  check: "100% Consistent",
                },
                {
                  icon: faLightbulb,
                  title: "Continuous Innovation",
                  desc: "We continuously improve through technology, research, and learning to meet evolving livestock nutrition needs.",
                  check: "Always Improving",
                },
              ].map((item, index) => (
                <motion.div
                  key={index}
