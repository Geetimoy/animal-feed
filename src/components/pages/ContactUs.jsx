        ...
        <section className="relative z-0 ">
          <div className="relative">
            ...
            <div className="absolute inset-0  flex items-center justify-center flex-col">
              ...
              <p className="text-white text-[16px] md:text-xl text-center px-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-10 ">
              ...
              <div className="space-y-6  md:space-y-8 py-2 order-2 md:order-1">
                ...
                <div className="group flex items-center gap-8 pb-2 md:pb-6 border-b border-gray-200">
                  <div
        ...
        <section className="mt-4">
          <div className="">
            <div className="relative z-10 max-w-5xl mx-auto px-6 text-center mb-8 ">
              {/* Heading */}
              <h2 className="text-3xl md:text-5xl font-semibold tracking-wide text-gray-900">
                Our
            ...
            {/* Map */}
            <div className="w-full h-[250px] md:h-[480px] rounded-xl overflow-hidden border border-gray-200 shadow-sm">
              {/* <iframe
