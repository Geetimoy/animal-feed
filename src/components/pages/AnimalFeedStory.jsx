          ...
          <div className="mt-10 max-w-6xl mx-auto">
            ...
            >
              <div className="relative aspect-video w-full bg-gray-900">
                ...
                >
                  <source
                    src="https://videos.pexels.com/video-files/854315/854315-hd_1920_1080_25fps.mp4"
                    type="video/mp4"
                  />
                </video>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-4 md:mt-12 md:items-start items-center justify-center">
              {/* Left: story section */}
              <motion.div
                className="space-y-4"
                variants={fadeInUp}
              ...
              >
                <h3 className="text-2xl md:text-3xl font-semibold text-gray-800 flex items-center gap-2 text-center justify-center md:justify-start">
                  ...
                  />
                  Rooted in{" "}
                  <span className="text-[#ffa800] ml-0 md:ml-2">tradition</span>
                </h3>
                <p className="text-gray-600 leading-normal md:leading-relaxed text-[16px] md:text-[18px] text-center md:text-left">
                  Rooted in regions where hard work meets agriculture, Green
                  Gold began with a clear purpose: to deliver high-quality,
                  dependable, and cost-effective animal feed that farmers can
                  rely on with confidence. We recognize that livestock
                  represents more than income—it is a way of life, a commitment,
                  and a heritage carried forward through generations.
                </p>
              ...
              >
                ...
                <p className="text-gray-600 leading-relaxed text-base text-center md:text-left">
                  Watch how we partner with local farmers, source ingredients
                  responsibly, and produce feed that nourishes both livestock
                  and the land.
                </p>
          ...
          <div className="max-w-6xl mx-auto mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-gray-700 text-base leading-relaxed text-center md:text-left">
                At Green Gold Animal Feed, sustainability goes beyond words. We
                emphasize locally sourced ingredients, actively support regional
                farmers, and follow responsible production practices that
                protect the environment while contributing to rural economic
                growth.
              </p>
            ...
            >
              ...
              <p className="text-gray-700 text-base leading-relaxed text-center md:text-left">
                Serving a wide range of livestock—including cattle, goats, pigs,
                poultry, and yaks—Green Gold Animal Feed offers customized feed
                solutions designed to meet species-specific and growth-stage
