          ...
          >
            <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
              <h3 className="text-2xl font-semibold text-gray-800 flex items-center gap-2">
                ...
                <span>
                  ...
                  <span className="text-[#ffa800]">{sustainability.highlight}</span>
                </span>
              </h3>
            ...
            <div className="flex flex-wrap gap-4 mt-6">
              <motion.div
                ...
                whileHover={{ scale: 1.05 }}
              >
                <div className="font-bold text-[#009a62] text-lg">  {livestock?.stat_circles?.[0]?.number}</div>
              ...
              <motion.div
                ...
                whileHover={{ scale: 1.05 }}
              >
                <div className="font-bold text-[#009a62] text-lg">{livestock?.stat_circles?.[0]?.label}</div>
          ...
          >
            ...
            <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
              <h3 className="text-[22px] md:text-2xl font-semibold text-gray-800 flex items-center gap-2">
                ...
                <span>
                  {livestock.heading}{" "}
                  <span className="text-[#ffa800]">{livestock.highlight}</span>
                </span>
              </h3>
              {/* <span className="w-12 h-12 bg-[#ffa800]/20 rounded-2xl flex items-center justify-center text-[#b57c00] text-xl">
                  <FontAwesomeIcon icon={faSeedling} />
            ...
            {/* <div className="flex justify-between mt-6 gap-2">
              {livestock?.stat_circles?.map((item, index) => (
                <motion.div
                  key={index}
                  className="text-center flex-1 bg-white/70 py-3 px-1 rounded-2xl shadow-sm border border-dashed border-[#ffa800]/30"
                  whileHover={{ scale: 1.1, rotate: index === 1 ? 2 : -2 }}
                >
                  ...
                  <span className="text-[11px] font-medium text-gray-500">
                    {defaultLabels[index] || item.label}
                  </span>
                </motion.div>
              ))}
            </div> */}
            ...
            <div className="flex justify-between mt-6 gap-2">
              ...
              >
                <div className="text-2xl font-black text-gray-800">
                  {livestock?.stat_circles?.[0]?.number}
                </div>
                <span className="text-[11px] font-medium text-gray-500">
                  Years Legacy
                </span>
              ...
              >
                <div className="text-2xl font-black text-gray-800">
                  {livestock?.stat_circles?.[0]?.label}
                </div>
                <span className="text-[11px] font-medium text-gray-500">
                  Quality Focus
                </span>
